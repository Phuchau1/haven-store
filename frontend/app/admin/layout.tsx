...
import {
    ...
    ClipboardList, BarChart3, Navigation, ShieldCheck, ArrowLeftRight, RotateCcw, Mail, Award
} from 'lucide-react';
...
const MENU_ITEMS = [
    ...
    { icon: Award,           label: 'Tích điểm & VIP', href: '/admin/loyalty',         group: 'store' },
...
const GROUPS = [
    ...
    { key: 'catalog', label: 'Sản phẩm & Danh mục' },
