            ...
            <div className="container-torano py-20 lg:py-24">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-1">
                        <Link href="/" className="inline-block bg-white px-3 py-1.5 rounded-xl hover:bg-gray-50 transition-colors mb-4">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src="/logo-new.png" alt="HAVEN" className="h-[48px] w-auto object-contain drop-shadow-sm" />
                        </Link>
