...
export default function Header() {
    ...
    return (
        <>
            {/* ── Header đứng yên ở đầu trang (không trôi đè khi chụp màn hình cuộn) ── */}
            <header className="w-full bg-white relative z-50 border-b border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
