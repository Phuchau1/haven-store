...
async function seedMenu() {
    ...
    try {
                ...
                children: [
                    {
                        ...
                        isActive: true,
                        children: [
                            { id: 'item-somi-nam', title: 'Áo sơ mi nam', link: '/collections/ao-so-mi-nam', order: 1, isActive: true },
                            { id: 'item-polo-nam', title: 'Áo polo nam', link: '/collections/ao-polo-nam', order: 2, isActive: true },
                            { id: 'item-tshirt-nam', title: 'Áo T-shirt nam', link: '/collections/ao-thun-nam', order: 3, isActive: true },
                            { id: 'item-khoac-nam', title: 'Áo khoác nam', link: '/collections/ao-khoac-nam', order: 4, isActive: true }
                        ]
                    },
                    {
                        id: 'col-quan-nam',
                        title: 'Quần Nam',
                        link: '/collections/quan-nam',
                        order: 2,
                        isActive: true,
                        children: [
        ...
        console.log(`Seeded ${menus.length} top-level menus successfully!`);
    } catch (error) {
